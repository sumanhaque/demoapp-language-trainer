...
public class PresenterLessonDetailsQuestion {
    ...
    public PresenterLessonDetailsQuestion(Context context, Listener listener) {
    ...
    public void matchSpeechWithText(String src, String test) {
        AsyncTask<String, Integer, Integer> taskCheckMatch =
                new AsyncTask<String, Integer, Integer>() {
                    ...
                    protected Integer doInBackground(String... params) {
                        ...
                        int res = StringUtil.getMatchPercent(src, test);
                        return res;
                    }
                    ...
                    protected void onPostExecute(Integer res) {
                        super.onPostExecute(res);
                        if (listener != null) {
                            listener.speechMatchResult(res);
                        }
                    }
                };
        taskCheckMatch.execute(new String[]{src, test});
    }
}
